...
c <- read_csv(here("files", "2025-07-02_HakaiData_chlorophyll.csv"))

# 2025-03-25_HakaiData_chlorophyll

#Downloading PAR data from pruth and Koeye - not currently using.
