...
```{r}
junk <- GET('https://catalogue.hakai.org/erddap/griddap/sentinel_3A_POLYMER.nc?chl_conc%5B(2024-07-19T00:00:00Z):1:(2024-07-19T00:00:00Z)%5D%5B(51.327609481637374):1:(52.07418357526005)%5D%5B(-128.29298012857942):1:(-127.54648012747612)%5D', write_disk("chl.nc", overwrite = TRUE))
...
```{r}
write.csv(lwst_obs2, here("outputs", "sentinel_2024-07-19_bigger.csv"))
```
